        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex justify-content-between">
              <h4 class="card-title mg-b-0 mt-2">Pending Partners</h4>
                  ...
                  <tbody>
                    @foreach ($partnerDatas as $partnerData)
                      <tr>
                        ...
                        <td><a href="{{ url('/admin/partner/' . $partnerData->id . '/edit?pending=true') }}"
                            class="btn ripple btn-primary text-white btn-icon"><i class="fe fe-edit"></i></a></td>
                        <td>
                          <form action="{{ route('partner.approve', $partnerData->id) }}" method="POST">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <button onclick="return confirm('Are you sure you want to approve this partner?');"
                              class="btn ripple btn-primary text-white btn-icon"><i
                                class="fe fe-check btn ripple btn-success text-white btn-icon"></i></button>
                          </form>
                        </td>
                      </tr>
                    @endforeach
        ...
        <form method="post" action="{{ url('admin/partnerexcel/store') }}" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="details-form-field form-group row">
              ...
              <div class="col-sm-6">
                <a href="{{ url('backEnd/partnerexcel.xlsx') }}" class="btn btn-success btn">Download<i
