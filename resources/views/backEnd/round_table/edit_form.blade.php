        ...
        <div class="card">
          <div class="card-body">
            <div class="main-content-label mg-b-5">
              Edit Round Table Event
            </div>
            <form method="post" action="{{ route('admin.update_round_table', ['id' => $event->id]) }}"
                ...
                <div class="col-4">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="text" class="form-control" name="round_table_title" id="round_table_title"
                      placeholder="Enter Event Name" value="{{ $event->round_table_title ?? '' }}" required>
                  </div>
                </div>
                    ...
                    <div class="col-9">
                      <div class="form-group mg-b-0">
                        ...
                        <input type="file" class="form-control" id="profile-img" name="round_table_poster"
                          id="round_table_poster">
                      </div>
                    </div>
                    <div class="col-3">
                      @if ($event->round_table_poster)
                        <img src="{{ asset('we/images/' . $event->round_table_poster) }}" height="70" width="70"
                          alt="poster">
                      @endif
                    </div>
                  </div>
                ...
                <div class="col-4">
                  <div class="form-group mg-b-0">
                    ...
                    <select class="form-control" name="round_table_mode" id="round_table_mode" required>
                      ...
                      @if ($event->round_table_mode == 'online')
              ...
              <div class="row row-sm">
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="round_table_start_date" id="round_table_start_date"
                      value="{{ $event->round_table_start_date ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="round_table_end_date" id="round_table_end_date"
                      value="{{ $event->round_table_end_date ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="round_table_from" id="round_table_from"
                      value="{{ $event->round_table_from ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="round_table_to" id="round_table_to"
                      value="{{ $event->round_table_to ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-12">
                  <div class="form-group mg-b-0">
                    ...
                    <textarea class="form-control summernote" name="round_table_desc" id="round_table_desc" rows="3"
                      placeholder="" required>{!! $event->round_table_desc ?? '' !!}</textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="row row-sm">
                <div class="d-flex pagination wd-100p">
                  <a href="{{ url('admin/round_table/list') }}" class="btn btn-main-primary pd-x-20 mg-t-10">Back</a>
