      ...
      <div class="col-lg-12 col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.create_we_pitch') }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row row-sm">
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="we_pitch_start_date" id="we_pitch_start_date" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="we_pitch_end_date" id="we_pitch_end_date" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="we_pitch_from" id="we_pitch_from" required> 
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="we_pitch_to" id="we_pitch_to" required>
                  </div>
                </div>
              ...
              <div class="row row-sm">
                ...
                <div class="col-12">
                  <div class="form-group mg-b-0">
                    ...
                    <textarea class="form-control summernote" name="we_pitch_desc" id="we_pitch_desc" rows="3" placeholder="" required></textarea>
                  </div>
                </div>
              </div>
