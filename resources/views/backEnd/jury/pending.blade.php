        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="d-flex justify-content-between">
              <h4 class="card-title mg-b-0 mt-2">Pending Jury Members</h4>
                  ...
                  <tbody>
                    @foreach ($juryDatas as $juryData)
                      <tr>
                        ...
                        <td>
                          <form action="{{ route('jury.approve', $juryData->id) }}" method="POST">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <button onclick="return confirm('Are you sure you want to approve this Jury?');"
