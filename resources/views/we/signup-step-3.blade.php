@extends('we.layouts.layout') @section('front_content')
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 to_animate" data-animation="fadeInRight">
          @if ($email_verify_warning)
            <div class="alert alert-yellow alert-dismissible">
              <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
              We’ve sent you a verification mail on {{ $email }}. Kindly click on the link and verify your email
              address.
            </div>
          @endif
          ...
          <div class="login-section signup-steps">
            ...
            <form class="login-form" method="post" action="{{ route('signupstep3') }}">
              ...
              <div class="form-group">
                ...
                <input type="text" name="companyname" value="{{ old('companyname') }}" placeholder="Eg: Facebook"
                  class="form-control" required>
              </div>

              <div class="form-group">
                <label>Your current designation?</label>
                <input type="text" name="designation" value="{{ old('designation') }}" placeholder="Eg: Product Manager"
                  class="form-control" required>
              </div>
              <div class="form-group">
                <label>Years of experience?</label>
                <div class="quantity quantity-input ">
                  <input type="number" name="experience" value="{{ old('experience') }}" class="form-control input-no"
              ...
              <div class="form-group">
                ...
                <select class="select-icon" name="highestqualification">
                  <option value="primary_school">Primary School</option>
                  <option value="higher_school">Higher School </option>
              ...
              <div class="form-group">
                ...
                <select name="industrytype" class="select-icon">
                  @foreach ($sectors as $sector)
                    <option name="industrytype" value="{{ $sector->sectorname }}">{{ $sector->sectorname }}</option>
              ...
              <div class="form-group">
                ...
                <input type="text" name="facebook" value="{{ old('facebook') }}"
                  placeholder="Eg: Linked, Facebook, Instagram, Pintrest etc" class="form-control"
                  onkeyup="socialMediaVal()" required>
                <ul id="socialMediaV">
                  <li style="font-size: 0.8em;">URL must be like https://www.facebook.com/user-name or
                    www.facebook.com/user-name.</li>
                </ul>
              </div>
              <div class="form-group">
                ...
                <div class="gender-box">
                  <div class="gender-iner">
                    <input type="radio" value="givesupport" name="hereto">Give Support
                  </div>
                  <div class="gender-iner">
                    <input type="radio" value="seeksupport" name="hereto">Seek Support
                  </div>
                </div>
              </div>
              <div class="form-group" style="display:flex; align-items: center;">
                <input type="checkbox" id="tnc" name="tnc" onclick="TnC()">
                <label for="tnc" style="margin-top: 15px; margin-left: 10px; font-size: 15px;">Terms and
                  conditions</label>
  ...
  <script>
    $(document).ready(function() {
      jQuery(
        '<div class="quantity-nav"><button class="quantity-button quantity-up"><i class="fa fa-angle-up" aria-hidden="true"></i></button><button class="quantity-button quantity-down"><i class="fa fa-angle-down" aria-hidden="true"></i></button></div>'
