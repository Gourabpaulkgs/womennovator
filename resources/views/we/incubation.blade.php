                    ...
                    <div class="community-ban-cintent">
                        ...
                        <div class="female-user-content">
                            ...
                            <ul class="communi-list">
                                <li>Get your startup incubated with award winning teams that’ve led 100s of early stage
                                    startups through Angel and Series A rounds. </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="incubation-de-rt">
                                <p>The WE - Virtual Incubation Program for Women is a 10 weeks digital incubation program
                                    for women enterprise based in India across various sectors.</p>
                                <p>The program is designed to bring the best of Womennovator's programs to women-led
                                    ventures across the various sectors.</p>
                            </div>
                        </div>
                    ...
                    <div class="why-incubation-sec">
                        ...
                        <div class="why-wo-title">
                            <h4>Why Womennovator Incubation?</h4>
                        </div>
                        <br>
                        <p>
                            We believe in empowering women to raise capital, grow their businesses, and create jobs that
                            lift families out of extreme poverty. But research shows that female founders only receive 11%
                            of seed financing. This cohort will explore issues around the gender financing gap and work
                            together to tackle the barriers women entrepreneurs face in their fundraising journey.
                    ...
                    <div class="incubate-form">
                        ...
                        <div class="incubate-form-sec">
                            <form action="{{ url('we/add/incubation') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group skip">
                                    <input type="checkbox" name="skip_or_not"> Skip Pitch Deck (You will have to enter all
                                    details manually)
                                </div>
                        ...
                        <div class="note">
                            ...
                            <ul>
                                ...
                                <li>Access is entirely basis criteria and first come first serve basis. View the entire
                                    creteria here.</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><img
                            src="images/close-icon.png"></button>
