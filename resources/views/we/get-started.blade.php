            ...
            <form class="login-form" method="post" action="{{ route('we.register') }}">
              ...
              <div class="form-group">
                <input type="text" name="email" value="{{ old('email') }}" placeholder="Enter your email address"
                  class="form-control" onkeyup="emailValid()" required>
                <ul id="emailV">
              ...
              <div class="form-group">
                <input type="password" name="password" placeholder="Enter a password" class="form-control"
                  onkeyup="passwordValid()" required>
                <ul>
              ...
              <div class="form-group">
                <div class="login">
                  <button type="submit" value="submit" class="login-btn">Sign up</button><a
                    href="{{ route('we.login') }}">already have an account?</a>
                </div>
              </div>
            </form>
          </div>
