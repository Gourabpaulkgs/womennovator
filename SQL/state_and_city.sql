...
--
-- Table structure for table `state_and_city`
--

CREATE TABLE `state_and_city` (
...
--
-- Dumping data for table `state_and_city`
--

INSERT INTO `state_and_city` (`city_id`, `city_name`, `state_id`, `state_name`) VALUES
...
--
-- Indexes for table `state_and_city`
--
ALTER TABLE `state_and_city`
...
--
-- AUTO_INCREMENT for table `state_and_city`
--
ALTER TABLE `state_and_city`
